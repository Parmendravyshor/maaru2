...
//                 itemBuilder: (context, index) {
//                   var title = snapshot.data.users[index].pet_name;
...
// //                   return Column(
// //                     children: <Widget>[
// //                       Text('Title: ${snapshot.data.users[index].pet_name}'),
// //                       Text('Body: ${snapshot.data.users[index].id}'),
// //                     ],
// //                   );
// //                 },
// //               );
...
//       .get(MaruConstant.createpProfile,
//   headers: headers
//   );
// print(response.body);
//   if (response.statusCode == 200) {
...
//     // then parse the JSON.
//     return Album1.fromJson(jsonDecode(response.body));
//   } else {
...
//     return Album1(
//       userId: json['pet_profiles'],
//
//       id: json ['pet_profiles'] [0]['id'],
//       title: json['pet_profiles'],
//     );
//   }
// }
//
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          ...
          body: Center(
            child: ListView.builder(
                itemCount: pet_profiles.length,
                itemBuilder: (BuildContext context, int index) {
                  return ListTile(
                      leading: Icon(Icons.list),
                      trailing: Text(
                      pet_profiles[index]['pet_name'],
