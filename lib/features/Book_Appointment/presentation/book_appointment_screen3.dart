    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          Container(
            ...
            //   width: 200,
            child: Align(
                alignment: Alignment.centerRight, child: MyStatefulWidget()),
          ),
          SizedBox(
            height: 20,
          ),
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: widget.isPressed ? MaaruColors.blueColor : Colors.white,
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  Widget build(BuildContext context) {
    return DropdownButton<String>(
      ...
      items: <String>['Grooming', 'Walking', 'Vet', 'Hotel']
