                        ...
                        Padding(
                            ...
                            child: Stack(fit: StackFit.loose, children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                widget.img ==null?  GestureDetector(
                                    child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        ThemedTextField(
                                            ...
                                            onChanged: (text) {
                                              _prefHelper.saveString(
                                                  MaruConstant.height, _heightController.text)?? _prefHelper.saveString(
                                                  MaruConstant.height, _heightController.text) ;
                                            },
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                onTap: () {
                                                  ...
                                                  String date =
                                                      textEditingController.text;
                                              if(widget.img ==null) {   if (_image.isEmpty) {
                                                _showDialog(
                                                  context,
                                                  "Please Select Image",
                                                );
                                              ...
                                              //     }
                                                    ...
                                                    if (widget.id1 !=null) {
                                                      ...
                                                      BlocProvider.of<
                                                          ...
                                                          context)
                                                          .add(Profile2('', ''));
                                                      AlertManager.showErrorMessage('Profile updated Successful', context);
                                                      Navigator.of(context).push(
                                                          MaterialPageRoute(
                                                              builder: (_) =>
                                                                  ViewPetProfile(
