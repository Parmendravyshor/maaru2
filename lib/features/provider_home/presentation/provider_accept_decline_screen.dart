                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child: Text(
                                                                            state.getProviderRequestModel.appointmentRequests[index].companyName
                                                                                .toString(),
                                                                            style:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          padding:
                                                                              const EdgeInsets.only(left: 15.0),
                                                                          child:
                                                                              Text('${state.getProviderRequestModel.appointmentRequests[index].companyCity.toString()} ${a[index].companyZipCode.toString()} ${a[index].companyState.toString()}'),
                                                                        ),
                                                                      )),
                                                                  Container(
                                                                      alignment:
                                                                      ...
                                                                      child: InkWell(
                                                                        onTap:
                                                                          ...
                                                                          Navigator.of(context)
                                                                              .push(MaterialPageRoute(builder: (_) => ProviderBookedConfirm()));
                                                                        },
                                                                        child:
                                                                            const Text(
                                                                          'View Details',
