                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                                        ...
                                                        MaterialPageRoute(
                                                            builder: (_) =>
                                                                CreateregisterPetProfile1(
                                                                  id1: widget
                                                                      .id1,
                                                                  age: state.welcome2.getSinglePe.age,
                                                                  weight: state.welcome2.getSinglePe.weight,
                                                                  img: state.welcome2.getSinglePe.img,
                                                                  height: state
                                                                      .welcome2
                                                                      .getSinglePe
                                                                      .height,
                                        ...
                                        Text(
                                          state.welcome2.getSinglePe.breedType
                                              .toString(),
                                                        ...
                                                        ? ListView.builder(
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              if (state
                                                                ...
                                                                return InkWell(
                                                                  onTap: (){
                                                                   Navigator.of(context).push(MaterialPageRoute(builder: (_)=>BookedConfirm(id4: state.upcomingPastAppointmentModel.upcomingBookings[index].bookingId,)));
                                                                  },
                                                                  child: Padding(
                                                                      padding:
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                //  height: 200,
                                                                                  width: 120,
                                                                                  child: Image.network(
                                                                                   state.upcomingPastAppointmentModel.upcomingBookings[index].petImage,
                                                                                    fit: BoxFit.fitWidth,
                                                                                    errorBuilder: (context, error, stackTrace) {
                                                                                      return Container(
                                                                                          color: Colors.amber,
